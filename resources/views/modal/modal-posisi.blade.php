@php
    ...
    $jabatan_id = '';
    $nama = '';
    $query = \App\Models\Posisi::find(request()->parent);
    if ($query) {
...
@endphp
<form action="{{ route('posisi.store') }}" onsubmit="return false" method="post" id="form-action">
    @csrf
    ...
    <div class="modal-body">
        ...
        <x-form-input label="Nama" type="text" name="nama" placeholder="Tulis nama posisi" :value="$nama" />
    </div>
