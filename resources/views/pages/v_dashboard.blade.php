                            ...
                            <table class="table text-nowrap mb-0 align-middle table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center product">
                                                <img src="{{ asset('assets') }}/images/products/s1.jpg"
                                                    class="img-fluid flex-shrink-0 rounded" width="60"
                                                    height="60" />
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center product">
                                                <img src="{{ asset('assets') }}/images/products/s2.jpg"
                                                    class="img-fluid flex-shrink-0 rounded" width="60"
                                                    height="60" />
                                                <div class="ms-3 product-title">
                                                    <h6 class="fs-3 mb-0 text-truncate-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center product">
                                                <img src="{{ asset('assets') }}/images/products/s3.jpg"
                                                    class="img-fluid flex-shrink-0 rounded" width="60"
                                                    height="60" />
                                                <div class="ms-3 product-title">
                                                    <h6 class="fs-3 mb-0 text-truncate-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center product">
                                                <img src="{{ asset('assets') }}/images/products/s5.jpg"
                                                    class="img-fluid flex-shrink-0 rounded" width="60"
                                                    height="60" />
                                                <div class="ms-3 product-title">
                                                    <h6 class="fs-3 mb-0 text-truncate-2">
        ...
        <div class="row">
                ...
                <div class="card overflow-hidden hover-img">
                    <div class="position-relative">
                        <a href="javascript:void(0)">
                            <img src="{{ asset('assets') }}/images/blog/blog-img1.jpg" class="card-img-top"
                                alt="materialM-img">
                        </a>
                        <span
                            class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                            min Read</span>
                        <img src="{{ asset('assets') }}/images/profile/user-3.jpg" alt="materialM-img"
            ...
            <div class="col-lg-4">
                <div class="card overflow-hidden hover-img">
                    <div class="position-relative">
                        <a href="javascript:void(0)">
                            <img src="{{ asset('assets') }}/images/blog/blog-img2.jpg" class="card-img-top"
                                alt="materialM-img">
                        </a>
                        <span
                            class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                            min Read</span>
                        <img src="{{ asset('assets') }}/images/profile/user-2.jpg" alt="materialM-img"
                            class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40"
                            height="40" data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-title="Georgeanna Ramero">
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card overflow-hidden hover-img">
                    <div class="position-relative">
                        <a href="javascript:void(0)">
                            <img src="{{ asset('assets') }}/images/blog/blog-img3.jpg" class="card-img-top"
                                alt="materialM-img">
                        </a>
                        <span
                            class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
...
@pushOnce('scripts')
    ...
    <script>
        ...
        //         'page-wrapper'); // Replace with your sidebar element ID or class
        //     // const sidebarToggle = document.getElementById(
        //     //     'sidebarToggle'); // Replace with your sidebar toggle element ID or class
        //     // console.log(sidebar.);
        //     // sidebar.addClass('newClassWithYourStyles').removeClass('theClassThatsTherenow');
        //     for (let i = 0; i < sidebar.length; i++) {
        //         // Ganti kelas 'old-class' dengan 'new-class'
        //         // sidebar[i].classList.remove('show-sidebar');
        //         // sidebar[i].classList.add('mini-sidebar');
        //     }
